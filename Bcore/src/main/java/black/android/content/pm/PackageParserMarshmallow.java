 ...
 * on Android M (Marshmallow, API 23). Provides access to the instance-based
...
public class PackageParserMarshmallow {
    ...
    /**
     * Collects certificates for a parsed package (Marshmallow variant).
     *
    ...
    /**
     * Parses an APK file into a Package object (Marshmallow variant).
     *
