 ...
 * on Android L (Lollipop, API 21). Provides access to the instance-based
...
public class PackageParserLollipop {
    ...
    /**
     * Collects certificates for a parsed package (Lollipop variant).
     *
    ...
    /**
     * Parses an APK file into a Package object (Lollipop variant).
     *
